...
class TabFragment1 : Fragment() {
    ...
    private val hopprBundle = Bundle().apply {
        this.putString(HopprParameter.SCREEN_NAME, "Tab1")
        this.putInt("TAB_NUMBER", 1)
    }
    ...
    override fun onCreateView(
        ...
        val launchActivityButton = fragmentView?.findViewById<Button>(R.id.launch_activity_button)
        launchActivityButton?.setOnClickListener {
            onButtonClicked("LaunchActivity1", Activity1::class.java)
        }

        val launchVideoActivityButton =
            fragmentView?.findViewById<Button>(R.id.launch_video_activity_button)
        launchVideoActivityButton?.setOnClickListener {
            onButtonClicked("LaunchVideoActivity", VideoActivity::class.java)
        }

        val launchAppsActivityButton =
            fragmentView?.findViewById<Button>(R.id.launch_apps_activity_button)
        launchAppsActivityButton?.setOnClickListener {
            onButtonClicked("LaunchAppsActivity", AppsActivity::class.java)
        }
