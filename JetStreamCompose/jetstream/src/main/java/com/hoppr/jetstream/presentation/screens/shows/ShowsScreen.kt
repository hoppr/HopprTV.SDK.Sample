...
package com.hoppr.jetstream.presentation.screens.shows
...
import com.hoppr.jetstream.presentation.screens.movies.MoviesScreenMovieList
...
private fun Catalog(
    ...
    ObserveHopprScreen(Bundle().apply {
        putString(HopprParameter.SCREEN_NAME, "shows")
        putInt("tvShowCount", tvShowList.size)
    })
